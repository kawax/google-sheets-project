                ...
                <div class="px-6 py-6 space-y-4">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <flux:button
                            ...
                            variant="primary"
                            color="zinc"
                            class="shadow-sm hover:bg-zinc-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-zinc-600">
                            View Source Code
                        </flux:button>
                        ...
                        <flux:button
                            ...
                            icon="book-open-text"
                            variant="outline"
                            class="shadow-sm hover:bg-zinc-50 dark:bg-zinc-800 dark:text-white dark:hover:bg-zinc-700">
                            View Live Sheet
                        </flux:button>
                    </div>
                </div>
