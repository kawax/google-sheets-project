<x-layouts.app title="Google Sheets Demo">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-zinc-900 dark:text-white">Google Sheets Integration Demo</h1>
        <p class="mt-2 text-lg text-zinc-600 dark:text-zinc-400">Submit data to Google Sheets and view recent entries in real-time</p>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="bg-white dark:bg-zinc-900 shadow-sm ring-1 ring-zinc-950/5 dark:ring-white/10 rounded-lg">
            <div class="border-b border-zinc-950/5 dark:border-white/10 px-6 py-4">
                ...
                <p class="mt-1 text-sm text-zinc-600 dark:text-zinc-400">Submit data to your Google Sheet</p>
            </div>
            <div class="px-6 py-6">
